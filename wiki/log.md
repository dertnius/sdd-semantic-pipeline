...
## 2026-06-10 | ingest | src/sdd_pipeline/embeddings.py + vector_store.py → learn/bridge/03-protocols-typing-and-unions.md
## 2026-06-10 | ingest | src/sdd_pipeline/retrieval.py + template_taxonomy.py → learn/bridge/04-iteration-comprehensions-generators.md
## 2026-06-10 | ingest | src/sdd_pipeline/pipeline.py + config.py + dump.py → learn/bridge/05-modules-imports-and-lazy-patterns.md
## 2026-06-10 | ingest | src/sdd_pipeline/config.py + cli.py → learn/bridge/06-pydantic-settings-and-typer.md
## 2026-06-10 | ingest | tests/conftest.py + tests/test_pipeline.py → learn/bridge/07-pytest-for-xunit-developers.md
## 2026-06-10 | ingest | src/sdd_pipeline/models.py + config.py → learn/tours/01-models-and-config.md
## 2026-06-10 | ingest | src/sdd_pipeline/ast_parser.py + structural.py → learn/tours/02-ast-parser-and-structural.md
## 2026-06-10 | ingest | src/sdd_pipeline/enrichment.py → learn/tours/03-enrichment.md
## 2026-06-10 | ingest | src/sdd_pipeline/vocabulary.py + pipeline.py → learn/tours/04-vocabulary-and-two-pass-scan.md
## 2026-06-10 | ingest | src/sdd_pipeline/{header_norm,template_taxonomy,corpus_taxonomy,doc_router}.py → learn/tours/05-taxonomy-modules.md
## 2026-06-10 | ingest | src/sdd_pipeline/{extract_structural,extract_prose,direction,reconcile}.py → learn/tours/06-inventory-extraction-modules.md
## 2026-06-10 | ingest | src/sdd_pipeline/chunking.py → learn/tours/07-chunking.md
