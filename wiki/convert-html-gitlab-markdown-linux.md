...
- Batch conversion scans `docs/**/*.html`, mirrors the source tree under the output directory, and produces a JSON report with per-file metrics (source: `docs/inbox/Convert.Linux.Readme.md`)
...
> **Decision [2026-06-06]:** Run the converter from the inner project root so the project `.venv` interpreter and dependencies are used. Source: `docs/inbox/Convert.Linux.Readme.md`
