...
- **Flow B (Phase 2, deferred):** `html_to_gitlab_md.py` — a standalone 1,209-line Confluence-HTML→Markdown converter. Zero imports from flow A. Read it only after you're fluent in flow A.
