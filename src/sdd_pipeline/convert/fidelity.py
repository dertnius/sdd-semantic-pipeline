...
try:
    ...
    from sdd_pipeline.convert.diagram_model import DiagramModel
    from sdd_pipeline.convert.drawio import drawio_to_model, model_to_drawio
    from sdd_pipeline.convert.gliffy_to_svg import parse_gliffy
